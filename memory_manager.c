...
void expand_inventory() {
    ...
    int *temp_ids = realloc(item_ids, expanded_size * sizeof(int));
    ...
    if (temp_ids == NULL) {
        ...
        item_ids = temp_ids;
        printf("Reallocated item_ids.\n");
    }
    
    
    // TODO: Use realloc to expand quantities from 3 to 6 integers
    int *temp_quantities = realloc(quantities, expanded_size * sizeof(int));
